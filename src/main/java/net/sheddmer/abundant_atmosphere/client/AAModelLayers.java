...
public class AAModelLayers {
    ...
    public static final ModelLayerLocation RED_BAMBOO_RAFT_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(AbundantAtmosphere.MODID, "boat/red_bamboo"), "main");
    public static final ModelLayerLocation RED_BAMBOO_CHEST_RAFT_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(AbundantAtmosphere.MODID, "chest_boat/red_bamboo"), "main");
