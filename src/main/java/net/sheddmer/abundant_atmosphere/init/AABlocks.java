...
public class AABlocks {
    ...
    public static final DeferredBlock<MossClumpBlock> MOSS_CLUMP = registerBlock("moss_clump", () -> new MossClumpBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).strength(0.1f, 0.1f).noCollission().noOcclusion().replaceable().sound(SoundType.MOSS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<MossClumpBlock> RUST_MOSS_CLUMP = registerBlock("rust_moss_clump", () -> new MossClumpBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).strength(0.1f, 0.1f).noCollission().noOcclusion().replaceable().sound(SoundType.MOSS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<BushFlowerBlock> SAFFRON_BUSHBUDS = registerBlock("saffron_bushbuds", () -> new BushFlowerBlock(MobEffects.POISON, 3.0F ,BlockBehaviour.Properties.ofFullCopy(Blocks.POPPY)));
    ...
    public static final DeferredBlock<BushFlowerBlock> CHERRY_BUSHBUDS = registerBlock("cherry_bushbuds", () -> new BushFlowerBlock(MobEffects.POISON, 3.0F ,BlockBehaviour.Properties.ofFullCopy(Blocks.POPPY)));
    ...
    public static final DeferredBlock<BushFlowerBlock> UMBRA_BUSHBUDS = registerBlock("umbra_bushbuds", () -> new BushFlowerBlock(MobEffects.POISON, 3.0F ,BlockBehaviour.Properties.ofFullCopy(Blocks.POPPY)));
    ...
    // Mud blocks
    public static final DeferredBlock<MudBlock> DAMP_MUD = registerBlock("damp_mud", () -> new MudBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD)));
    public static final DeferredBlock<MudBlock> WET_MUD = registerBlock("wet_mud", () -> new MudBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD)));
    ...
    public static final DeferredBlock<DoorBlock> DEEPSLATE_DOOR = registerBlock("deepslate_door", () -> new DoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DEEPSLATE)));
    public static final DeferredBlock<TrapDoorBlock> DEEPSLATE_TRAPDOOR = registerBlock("deepslate_trapdoor", () -> new TrapDoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DEEPSLATE)));
