...
public class AABlocks {
    ...
    public static final DeferredBlock<Block> BLACKSALT_TILE_STAIRS = registerBlock("blacksalt_tile_stairs", () ->  new StairBlock(BLACKSALT_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BLACKSALT_TILES.get())));
    public static final DeferredBlock<Block> BLACKSALT_TILE_SLAB = registerBlock("blacksalt_tile_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSALT_TILES.get())));
    // Calcite blocks
    ...
    public static final DeferredBlock<Block> CALCITE_TILE_STAIRS = registerBlock("calcite_tile_stairs", () ->  new StairBlock(CALCITE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES.get())));
    public static final DeferredBlock<Block> CALCITE_TILE_SLAB = registerBlock("calcite_tile_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES.get())));
    public static final DeferredBlock<Block> CALCITE_TILE_WALL = registerBlock("calcite_tile_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES.get()).forceSolidOn()));
    // Dripstone blocks
    ...
    public static final DeferredBlock<Block> DRIPSTONE_TILE_STAIRS = registerBlock("dripstone_tile_stairs", () ->  new StairBlock(DRIPSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_TILES.get())));
    public static final DeferredBlock<Block> DRIPSTONE_TILE_SLAB = registerBlock("dripstone_tile_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_TILES.get())));
    public static final DeferredBlock<Block> DRIPSTONE_TILE_WALL = registerBlock("dripstone_tile_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_TILES.get()).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> DRIPSTONE_SHINGLE_STAIRS = registerBlock("dripstone_shingle_stairs", () ->  new StairBlock(DRIPSTONE_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_SHINGLES.get())));
    public static final DeferredBlock<Block> DRIPSTONE_SHINGLE_SLAB = registerBlock("dripstone_shingle_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_SHINGLES.get())));
    public static final DeferredBlock<Block> DRIPSTONE_SHINGLE_WALL = registerBlock("dripstone_shingle_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(DRIPSTONE_SHINGLES.get()).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> MOSSY_SHUFFLED_BRICK_STAIRS = registerBlock("mossy_shuffled_brick_stairs", () ->  new StairBlock(MOSSY_SHUFFLED_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_SHUFFLED_BRICKS.get())));
    public static final DeferredBlock<Block> MOSSY_SHUFFLED_BRICK_SLAB = registerBlock("mossy_shuffled_brick_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_SHUFFLED_BRICKS.get())));
    public static final DeferredBlock<Block> MOSSY_SHUFFLED_BRICK_WALL = registerBlock("mossy_shuffled_brick_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_SHUFFLED_BRICKS.get()).forceSolidOn()));
    // Dowsite blocks
    ...
    public static final DeferredBlock<Block> RUST_MOSS_BLOCK = registerBlock("rust_moss_block", () -> new MossBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).strength(0.1f, 0.1f).sound(SoundType.MOSS).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> RUST_MOSS_CARPET = registerBlock("rust_moss_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).strength(0.1f, 0.1f).sound(SoundType.MOSS_CARPET).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> RUST_MOSS_CLUMP = registerBlock("rust_moss_clump", () -> new MossClumpBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).strength(0.1f, 0.1f).noCollission().noOcclusion().replaceable().sound(SoundType.MOSS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> LEAF_PILE = registerBlock("leaf_pile", () -> new LeafPileBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).instabreak().noCollission().noOcclusion().replaceable().sound(SoundType.CHERRY_LEAVES).pushReaction(PushReaction.DESTROY)));
    ...
    // Mud blocks
    public static final DeferredBlock<Block> DAMP_MUD = registerBlock("damp_mud", () -> new MudBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD)));
    public static final DeferredBlock<Block> WET_MUD = registerBlock("wet_mud", () -> new MudBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD)));
    ...
    public static final DeferredBlock<Block> MOSSY_MUD_BRICK_STAIRS = registerBlock("mossy_mud_brick_stairs", () ->  new StairBlock(MOSSY_MUD_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_MUD_BRICKS.get())));
    public static final DeferredBlock<Block> MOSSY_MUD_BRICK_SLAB = registerBlock("mossy_mud_brick_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_MUD_BRICKS.get())));
    public static final DeferredBlock<Block> MOSSY_MUD_BRICK_WALL = registerBlock("mossy_mud_brick_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_MUD_BRICKS.get()).forceSolidOn()));
    ...
    // Mossy Blocks
    public static final DeferredBlock<Block> STONE_WALL = registerBlock("stone_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> MOSSY_STONE_STAIRS = registerBlock("mossy_stone_stairs", () ->  new StairBlock(MOSSY_STONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_STONE.get())));
    public static final DeferredBlock<Block> MOSSY_STONE_SLAB = registerBlock("mossy_stone_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_STONE.get())));
    public static final DeferredBlock<Block> MOSSY_STONE_WALL = registerBlock("mossy_stone_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_STONE.get()).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> MOSSY_COBBLED_DEEPSLATE_STAIRS = registerBlock("mossy_cobbled_deepslate_stairs", () ->  new StairBlock(MOSSY_COBBLED_DEEPSLATE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_COBBLED_DEEPSLATE.get())));
    public static final DeferredBlock<Block> MOSSY_COBBLED_DEEPSLATE_SLAB = registerBlock("mossy_cobbled_deepslate_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_COBBLED_DEEPSLATE.get())));
    public static final DeferredBlock<Block> MOSSY_COBBLED_DEEPSLATE_WALL = registerBlock("mossy_cobbled_deepslate_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_COBBLED_DEEPSLATE.get()).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> MOSSY_POLISHED_DEEPSLATE_STAIRS = registerBlock("mossy_polished_deepslate_stairs", () ->  new StairBlock(MOSSY_COBBLED_DEEPSLATE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_COBBLED_DEEPSLATE.get())));
    public static final DeferredBlock<Block> MOSSY_POLISHED_DEEPSLATE_SLAB = registerBlock("mossy_polished_deepslate_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_COBBLED_DEEPSLATE.get())));
    public static final DeferredBlock<Block> MOSSY_POLISHED_DEEPSLATE_WALL = registerBlock("mossy_polished_deepslate_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_COBBLED_DEEPSLATE.get()).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> MOSSY_DEEPSLATE_BRICK_STAIRS = registerBlock("mossy_deepslate_brick_stairs", () ->  new StairBlock(MOSSY_DEEPSLATE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_DEEPSLATE_BRICKS.get())));
    public static final DeferredBlock<Block> MOSSY_DEEPSLATE_BRICK_SLAB = registerBlock("mossy_deepslate_brick_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_DEEPSLATE_BRICKS.get())));
    public static final DeferredBlock<Block> MOSSY_DEEPSLATE_BRICK_WALL = registerBlock("mossy_deepslate_brick_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_DEEPSLATE_BRICKS.get()).forceSolidOn()));
    ...
    public static final DeferredBlock<Block> MOSSY_DEEPSLATE_TILE_STAIRS = registerBlock("mossy_deepslate_tile_stairs", () ->  new StairBlock(MOSSY_DEEPSLATE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MOSSY_DEEPSLATE_TILES.get())));
    public static final DeferredBlock<Block> MOSSY_DEEPSLATE_TILE_SLAB = registerBlock("mossy_deepslate_tile_slab", () ->  new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_DEEPSLATE_TILES.get())));
    public static final DeferredBlock<Block> MOSSY_DEEPSLATE_TILE_WALL = registerBlock("mossy_deepslate_tile_wall", () ->  new WallBlock(BlockBehaviour.Properties.ofFullCopy(MOSSY_DEEPSLATE_TILES.get()).forceSolidOn()));
    ...
    // Stone Doors
    public static final DeferredBlock<Block> STONE_DOOR = registerBlock("stone_door", () -> new DoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> STONE_TRAPDOOR = registerBlock("stone_trapdoor", () -> new TrapDoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.STONE)));
    public static final DeferredBlock<Block> DEEPSLATE_DOOR = registerBlock("deepslate_door", () -> new DoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DEEPSLATE)));
    public static final DeferredBlock<Block> DEEPSLATE_TRAPDOOR = registerBlock("deepslate_trapdoor", () -> new TrapDoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DEEPSLATE)));
    public static final DeferredBlock<Block> MUD_DOOR = registerBlock("mud_door", () -> new DoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.MUD_BRICKS)));
    public static final DeferredBlock<Block> MUD_TRAPDOOR = registerBlock("mud_trapdoor", () -> new TrapDoorBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.MUD_BRICKS)));
    public static final DeferredBlock<Block> BLACKSTONE_DOOR = registerBlock("blackstone_door", () -> new DoorBlock(BlockSetType.POLISHED_BLACKSTONE, BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_BLACKSTONE)));
    public static final DeferredBlock<Block> BLACKSTONE_TRAPDOOR = registerBlock("blackstone_trapdoor", () -> new TrapDoorBlock(BlockSetType.POLISHED_BLACKSTONE, BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_BLACKSTONE)));
    public static final DeferredBlock<Block> NETHER_BRICK_DOOR = registerBlock("nether_brick_door", () -> new DoorBlock(BlockSetType.POLISHED_BLACKSTONE, BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS)));
    public static final DeferredBlock<Block> NETHER_BRICK_TRAPDOOR = registerBlock("nether_brick_trapdoor", () -> new TrapDoorBlock(BlockSetType.POLISHED_BLACKSTONE, BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS)));
    ...
    public static final DeferredBlock<Block> ASHROOT_SIGN = BLOCKS.register("ashroot_sign", () -> new StandingSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
    public static final DeferredBlock<Block> ASHROOT_WALL_SIGN = BLOCKS.register("ashroot_wall_sign", () -> new WallSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));
    public static final DeferredBlock<Block> ASHROOT_HANGING_SIGN = BLOCKS.register("ashroot_hanging_sign", () -> new CeilingHangingSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
    public static final DeferredBlock<Block> ASHROOT_WALL_HANGING_SIGN = BLOCKS.register("ashroot_wall_hanging_sign", () -> new WallHangingSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
    ...
    // Gourdrot Woodset
    public static final DeferredBlock<Block> GOURDROT_LOG = registerBlock("gourdrot_log", () ->  new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).strength(2.0f, 2.0f).instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).ignitedByLava()));
    public static final DeferredBlock<Block> GOURDROT_WOOD = registerBlock("gourdrot_wood", () ->  new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).strength(2.0f, 2.0f).instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).ignitedByLava()));
    public static final DeferredBlock<Block> STRIPPED_GOURDROT_LOG = registerBlock("stripped_gourdrot_log", () ->  new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).strength(2.0f, 2.0f).instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).ignitedByLava()));
    public static final DeferredBlock<Block> STRIPPED_GOURDROT_WOOD = registerBlock("stripped_gourdrot_wood", () ->  new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).strength(2.0f, 2.0f).instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).ignitedByLava()));
    ...
    public static final DeferredBlock<Block> GOURDROT_SIGN = BLOCKS.register("gourdrot_sign", () -> new StandingSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
    public static final DeferredBlock<Block> GOURDROT_WALL_SIGN = BLOCKS.register("gourdrot_wall_sign", () -> new WallSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));
    public static final DeferredBlock<Block> GOURDROT_HANGING_SIGN = BLOCKS.register("gourdrot_hanging_sign", () -> new CeilingHangingSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
    public static final DeferredBlock<Block> GOURDROT_WALL_HANGING_SIGN = BLOCKS.register("gourdrot_wall_hanging_sign", () -> new WallHangingSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
    public static final DeferredBlock<Block> GOURDNUT = registerBlock("gourdnut", () -> new GourdnutBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(0.1f, 0.0f).noOcclusion().instrument(NoteBlockInstrument.DIDGERIDOO).sound(SoundType.CHERRY_WOOD).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> RED_BAMBOO_SIGN = BLOCKS.register("red_bamboo_sign", () -> new StandingSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
    public static final DeferredBlock<Block> RED_BAMBOO_WALL_SIGN = BLOCKS.register("red_bamboo_wall_sign", () -> new WallSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));
    public static final DeferredBlock<Block> RED_BAMBOO_HANGING_SIGN = BLOCKS.register("red_bamboo_hanging_sign", () -> new CeilingHangingSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
    public static final DeferredBlock<Block> RED_BAMBOO_WALL_HANGING_SIGN = BLOCKS.register("red_bamboo_wall_hanging_sign", () -> new WallHangingSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
    ...
    public static final DeferredBlock<Block> POTTED_RED_BAMBOO = BLOCKS.register("potted_red_bamboo", () -> new FlowerPotBlock(RED_BAMBOO.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BAMBOO)));
