...
public class AAFoods {
    ...
    public static final FoodProperties SQUASHBERRY_JAM = new FoodProperties.Builder().nutrition(8).saturationModifier(0.6F).usingConvertsTo(Items.GLASS_BOTTLE).build();
    ...
    public static final FoodProperties COOKED_TROPICAL_FISH = new FoodProperties.Builder().nutrition(4).saturationModifier(0.15F).build();
