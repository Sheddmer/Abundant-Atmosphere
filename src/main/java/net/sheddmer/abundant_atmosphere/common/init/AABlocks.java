...
public class AABlocks {
    ...
    // Blasalt blocks
    public static final DeferredBlock<Block> BLACKSALT_TILES = registerBlock("blacksalt_tiles", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).strength(1.4f, 1.4f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.BASALT)));
    ...
    public static final DeferredBlock<RotatedPillarBlock> INSCRIBED_BASALT = registerBlock("inscribed_basalt", () -> new OrientedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(1.25F, 4.2F).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.BASALT)));
    public static final DeferredBlock<RotatedPillarBlock> DEEPSLATE_PILLAR = registerBlock("deepslate_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).strength(3.5f, 6.0f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.DEEPSLATE_BRICKS)));
    // Calcite blocks
    public static final DeferredBlock<Block> POLISHED_CALCITE = registerBlock("polished_calcite", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.75f, 1.0f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.CALCITE)));
    ...
    // Dripstone blocks
    public static final DeferredBlock<Block> POLISHED_DRIPSTONE = registerBlock("polished_dripstone", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).strength(1.5f, 1.5f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.DRIPSTONE_BLOCK)));
    ...
    // Shuffled Bricks
    public static final DeferredBlock<Block> SHUFFLED_BRICKS = registerBlock("shuffled_bricks", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_GRAY).strength(2.5f, 8.0f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.NETHER_BRICKS)));
    ...
    public static final DeferredBlock<Block> MOSSY_SHUFFLED_BRICKS = registerBlock("mossy_shuffled_bricks", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_GREEN).strength(2.5f, 8.0f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.NETHER_BRICKS)));
    ...
    public static final DeferredBlock<CaveSproutsBlock> CAVE_SPROUTS = registerBlock("cave_sprouts", () ->  new CaveSproutsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.NONE).instabreak().noCollission().noOcclusion().replaceable().offsetType(BlockBehaviour.OffsetType.XYZ).sound(SoundType.NETHER_SPROUTS).ignitedByLava()));
    public static final DeferredBlock<CaveSproutsBlock> SHORT_CAVE_SPROUTS = registerBlock("short_cave_sprouts", () ->  new CaveSproutsBlock(BlockBehaviour.Properties.ofFullCopy(CAVE_SPROUTS.get()).offsetType(BlockBehaviour.OffsetType.XYZ).ignitedByLava()));
    ...
    public static final DeferredBlock<MultifacePlantBlock> MOSS_CLUMP = registerBlock("moss_clump", () -> new MultifacePlantBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).instabreak().noCollission().noOcclusion().replaceable().sound(SoundType.MOSS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<MultifacePlantBlock> RUST_MOSS_CLUMP = registerBlock("rust_moss_clump", () -> new MultifacePlantBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).instabreak().noCollission().noOcclusion().replaceable().sound(SoundType.MOSS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<RotatedPillarBlock> CHROMATIC_FROGLIGHT = registerBlockNoItem("chromatic_froglight", () ->  new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.3f, 0.3f).lightLevel(value -> 15).sound(SoundType.FROGLIGHT)));
    public static final DeferredBlock<LeafPileBlock> LEAF_PILE = registerBlockNoItem("leaf_pile", () -> new LeafPileBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).instabreak().noCollission().noOcclusion().replaceable().sound(SoundType.CHERRY_LEAVES).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<MushroomBlock> PORESHROOM = registerBlockNoItem("poreshroom", () ->  new MushroomBlock(AAFeatures.HUGE_PORESHROOM_CHECKED, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).instabreak().noCollission().noOcclusion().sound(SoundType.FUNGUS).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<WallFungusBlock> WALL_PORESHROOM = registerBlockNoItem("wall_poreshroom", () ->  new WallFungusBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).instabreak().noCollission().noOcclusion().sound(SoundType.FUNGUS).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<FlowerPotBlock> POTTED_PORESHROOM = registerBlockNoItem("potted_poreshroom", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.PORESHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_RED_MUSHROOM)));
    ...
    public static final DeferredBlock<CatsbaneBlock> CATSBANE = registerBlockNoItem("catsbane", () ->  new CatsbaneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).instabreak().noCollission().noOcclusion().sound(SoundType.FUNGUS).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<WallFungusBlock> WALL_CATSBANE = registerBlockNoItem("wall_catsbane", () ->  new WallFungusBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).instabreak().noCollission().noOcclusion().sound(SoundType.FUNGUS).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<FlowerPotBlock> POTTED_CATSBANE = registerBlockNoItem("potted_catsbane", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.CATSBANE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_RED_MUSHROOM)));
    public static final DeferredBlock<WaterlilyBlock> SMALL_LILY_PAD = registerBlockNoItem("small_lily_pad", () -> new WaterlilyBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).instabreak().noOcclusion().sound(SoundType.LILY_PAD).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<WaterLotusBlock> PINK_WATER_LOTUS = registerBlockNoItem("pink_water_lotus", () -> new WaterLotusBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).instabreak().noOcclusion().noCollission().sound(SoundType.PINK_PETALS).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<WaterLotusBlock> VIOLET_WATER_LOTUS = registerBlockNoItem("violet_water_lotus", () -> new WaterLotusBlock(BlockBehaviour.Properties.of().mapColor(MapColor.LAPIS).instabreak().noOcclusion().noCollission().sound(SoundType.PINK_PETALS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_MIDNIGHT_LILY = registerBlockNoItem("potted_midnight_lily", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.MIDNIGHT_LILY, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_SAFFRON_BUSHBUDS = registerBlockNoItem("potted_saffron_bushbuds", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.SAFFRON_BUSHBUDS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_CHERRY_BUSHBUDS = registerBlockNoItem("potted_cherry_bushbuds", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.CHERRY_BUSHBUDS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_UMBRA_BUSHBUDS = registerBlockNoItem("potted_umbra_bushbuds", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.UMBRA_BUSHBUDS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    ...
    public static final DeferredBlock<TallGrassBlock> BLOODROOT_BUSH = registerBlock("bloodroot_bush", () ->  new TallGrassBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).instabreak().noCollission().noOcclusion().replaceable().offsetType(BlockBehaviour.OffsetType.XZ).sound(SoundType.GRASS).ignitedByLava()));

    public static final DeferredBlock<CreepingCloverBlock> CREEPING_CLOVERS = registerBlock("creeping_clovers", () -> new CreepingCloverBlock(BlockBehaviour.Properties.of().instabreak().noCollission().noOcclusion().randomTicks().sound(SoundType.NETHER_SPROUTS).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<MudLampBlock> MUD_LAMP = registerBlockNoItem("mud_lamp", () ->  new MudLampBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).strength(0.5f, 1.0f).lightLevel(state -> state.getValue(MudLampBlock.LIT) ? 10 : 0).noOcclusion().sound(SoundType.PACKED_MUD).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<WallMudLampBlock> WALL_MUD_LAMP = registerBlockNoItem("wall_mud_lamp", () ->  new WallMudLampBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).strength(0.5f, 1.0f).lightLevel(state -> state.getValue(MudLampBlock.LIT) ? 10 : 0).noOcclusion().sound(SoundType.PACKED_MUD).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> ASHROOT_PLANKS = registerBlockNoItem("ashroot_planks", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_GRAY).strength(2.0f, 3.0f).instrument(NoteBlockInstrument.BASS).sound(SoundType.WOOD).ignitedByLava()));
    ...
    public static final DeferredBlock<StandingSignBlock> ASHROOT_SIGN = registerBlockNoItem("ashroot_sign", () -> new StandingSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
    public static final DeferredBlock<WallSignBlock> ASHROOT_WALL_SIGN = registerBlockNoItem("ashroot_wall_sign", () -> new WallSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> ASHROOT_HANGING_SIGN = registerBlockNoItem("ashroot_hanging_sign", () -> new CeilingHangingSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
    public static final DeferredBlock<WallHangingSignBlock> ASHROOT_WALL_HANGING_SIGN = registerBlockNoItem("ashroot_wall_hanging_sign", () -> new WallHangingSignBlock(AAWoodTypes.ASHROOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
    public static final DeferredBlock<LeavesBlock> ASHROOT_LEAVES = registerBlock("ashroot_leaves", () ->  new LeavesBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(0.2f, 0.2f).randomTicks().noOcclusion().ignitedByLava().sound(SoundType.AZALEA_LEAVES).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_ASHROOT_SAPLING = registerBlockNoItem("potted_ashroot_sapling", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.ASHROOT_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    ...
    public static final DeferredBlock<Block> GOURDROT_PLANKS = registerBlockNoItem("gourdrot_planks", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).strength(2.0f, 3.0f).instrument(NoteBlockInstrument.BASS).sound(SoundType.WOOD).ignitedByLava()));
    ...
    public static final DeferredBlock<StandingSignBlock> GOURDROT_SIGN = registerBlockNoItem("gourdrot_sign", () -> new StandingSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
    public static final DeferredBlock<WallSignBlock> GOURDROT_WALL_SIGN = registerBlockNoItem("gourdrot_wall_sign", () -> new WallSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> GOURDROT_HANGING_SIGN = registerBlockNoItem("gourdrot_hanging_sign", () -> new CeilingHangingSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
    public static final DeferredBlock<WallHangingSignBlock> GOURDROT_WALL_HANGING_SIGN = registerBlockNoItem("gourdrot_wall_hanging_sign", () -> new WallHangingSignBlock(AAWoodTypes.GOURDROT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_GOURDNUT = registerBlockNoItem("potted_gourdnut", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.GOURDNUT, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_AZALEA)));
    public static final DeferredBlock<GourdnutBlock> CARVED_GOURDNUT = registerBlock("carved_gourdnut", () -> new EquipableGourdnutBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(0.1f, 0.0f).noOcclusion().instrument(NoteBlockInstrument.DIDGERIDOO).sound(SoundType.WOOD).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> RED_BAMBOO_PLANKS = registerBlockNoItem("red_bamboo_planks", () ->  new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_RED).strength(2.0f, 3.0f).instrument(NoteBlockInstrument.BASS).sound(AASounds.RED_BAMBOO_WOOD).ignitedByLava()));
    ...
    public static final DeferredBlock<StandingSignBlock> RED_BAMBOO_SIGN = registerBlockNoItem("red_bamboo_sign", () -> new StandingSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
    public static final DeferredBlock<WallSignBlock> RED_BAMBOO_WALL_SIGN = registerBlockNoItem("red_bamboo_wall_sign", () -> new WallSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> RED_BAMBOO_HANGING_SIGN = registerBlockNoItem("red_bamboo_hanging_sign", () -> new CeilingHangingSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
    public static final DeferredBlock<WallHangingSignBlock> RED_BAMBOO_WALL_HANGING_SIGN = registerBlockNoItem("red_bamboo_wall_hanging_sign", () -> new WallHangingSignBlock(AAWoodTypes.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
    public static final DeferredBlock<RedBambooSaplingBlock> RED_BAMBOO_SAPLING = registerBlockNoItem("red_bamboo_sapling", () -> new RedBambooSaplingBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_SAPLING)));
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_RED_BAMBOO = registerBlockNoItem("potted_red_bamboo", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), AABlocks.RED_BAMBOO, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BAMBOO)));
    ...
    @SuppressWarnings("unchecked")
    public static <T extends Block> DeferredBlock<T> registerBlockNoItem(String name, Supplier<? extends Block> block) {
        DeferredBlock<Block> toReturn = BLOCKS.register(name, block);
        return (DeferredBlock<T>) toReturn;
    }
