...
public class AAFoods {
    ...
    public static final FoodProperties GOURDNUT_PUDDING = AAModCompats.FARMERSDELIGHT.isLoaded() ? new FoodProperties.Builder().nutrition(11).saturationModifier(0.6f).usingConvertsTo(Items.BOWL).build() : null;
