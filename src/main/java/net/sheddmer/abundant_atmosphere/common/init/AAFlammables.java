...
public class AAFlammables {
    public static void register() {
        ...
        fireBlock.setFlammable(AABlocks.RUST_MOSS_BLOCK.get(), 100, 260);
        fireBlock.setFlammable(AABlocks.RUST_MOSS_CARPET.get(), 120, 400);
        fireBlock.setFlammable(AABlocks.RUST_MOSS_CLUMP.get(), 120, 400);
        fireBlock.setFlammable(AABlocks.RUST_MOSS_SPROUTS.get(), 120, 400);
    }
}
