...
public class AAConditions {
    ...
    public static final Supplier<MapCodec<BambooConfigCondition>> BAMBOO_CONFIG_CONDITION = CONDITION_CODECS.register("bamboo_config", () -> BambooConfigCondition.CODEC);
    public static final Supplier<MapCodec<BambooConfigCondition>> BOOL_CONFIG_CONDITION = CONDITION_CODECS.register("boolean_config", () -> BoolConfigCondition.CODEC);
}
