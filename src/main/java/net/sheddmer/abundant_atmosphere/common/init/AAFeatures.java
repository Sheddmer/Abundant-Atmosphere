...
public class AAFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_RUST_MOSS_BONEMEAL = registerConfiguredFeature("patch_rust_moss_bonemeal");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_CAVE_SPROUTS = registerConfiguredFeature("patch_cave_sprouts");
